...
class GoogleAiPluginOptions(pydantic.BaseModel):
    ...
    api_version: Optional[Union[List[str], str]] = pydantic.Field(default=None)
    base_url: Optional[str] = pydantic.Field(default=None)
    models: Union[List, str] = pydantic.Field(default=str)
